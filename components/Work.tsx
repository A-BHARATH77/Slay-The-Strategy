    ...
    <div className="work-root">
      <style dangerouslySetInnerHTML={{
        ...
        @media (max-width: 768px) {
          ...
          .hero-title {
            font-size: 20vw;        /* readable on small screens */
            line-height: 0.85;
          }
          ...
          .work-grid {
            margin-top: 1rem !important;   /* remove the negative-margin trick on mobile */
          ...
          /* Ensure images don't overflow vertically or act weird on mobile */
          .tile-image-container {
            max-height: 70vh;
